...
\begin{titlepage}
    ...
    \huge \textnormal{EEE 372: Microprocessors \& Microcontrollers Laboratory}
    \vspace{1in} % Adjusts vertical space after the course title

    \Large \textnormal{Title: Solving Problems Using Assembly Language}
    ...
    \begin{tabular}{|p{0.4\textwidth}|p{0.6\textwidth}|} % Set column widths to 40% and 60%
        ...
        \hline
        \textbf{Submission Date} & 11.09.2024 \\
        \hline
    \end{tabular}
    \vspace{1cm}
